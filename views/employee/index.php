...
if (isset($_GET['action']) && $_GET['action'] == 'delete' && isset($_GET['id'])) {
    ...
    $model = new \models\EmployeeModel();
...
<div>
  ...
  <a href="employee/create" class="text-decoration-none ms-5 mb-2 p-1 rounded btn btn-outline-primary">Create Employee</a>
  <?= $viewHelper::dataTables($data, [
        'view' => function ($row) {
            return '<a class="text-decoration-none ms-5 p-1 rounded btn btn-outline-primary" href="employee/view?id=' . $row['id'] . '">View</a>';
        },
        'edit' => function ($row) {
          return '<a class="text-decoration-none ms-5 p-1 rounded btn btn-outline-primary" href="employee/edit?id=' . $row['id'] . '">Edit</a>';
        },
        'delete' => function ($row) {
